...
## L'outil principal : Claude Code

Mon interlocuteur principal, c'est **Claude Code**. Pas une interface web séparée, pas un autre outil — Claude Code directement intégré dans VS Code, là où je passe une bonne partie de mes journées.

Ce qui me plaît dans cette approche, c'est qu'elle est contextualisée : Claude Code lit mes fichiers, comprend l'arborescence de mon projet, et peut agir directement sur le code. On est loin du copier-coller entre une fenêtre de chat et son éditeur.
