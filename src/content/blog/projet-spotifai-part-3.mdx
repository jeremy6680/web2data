...
Le code source est sur [GitHub](https://github.com/jeremy6680/spotifai). La démo tourne sur [spotifai.web2data.org](https://spotifai.web2data.org) — envoie-moi ton email Spotify si tu veux tester.
