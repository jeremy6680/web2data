...
ChefRAG est déployé sur [chefrag.lumafinch.com](https://chefrag.lumafinch.com). Il tourne sur un VPS Hetzner CX21, géré avec Coolify, HTTPS automatique via Let's Encrypt. Le code est open-source sur GitHub — [lien à compléter].
