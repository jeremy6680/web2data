...
export const ui = {
  en: {
    ...
    "layouts.postLayout.category": "Category",
    "layouts.postLayout.tags": "Topics",
  ...
  fr: {
    ...
    "pages.tags.title": "Sujets",
    "pages.tags.description": "Tous les sujets utilisés sur le blog",
    "pages.tags.allTags": "Tous les sujets",
    "pages.tags.noTags": "Aucun sujet trouvé",
    "pages.tags.viewPosts": "Voir tous les articles avec le sujet {tag}",
    ...
    "layouts.postLayout.category": "Catégorie",
    "layouts.postLayout.tags": "Sujets",
