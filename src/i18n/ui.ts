...
export const ui = {
  en: {
    ...
    "pages.technos.description": "All technologies and tools used in the blog",
    "pages.technos.allTechnos": "All technos",
    "pages.technos.noTechnos": "No technos found",
    "pages.technos.viewPosts": "View all posts with techno {techno}",
    ...
    "layouts.listWithTagsLayout.showFilters": "Filter",
    "layouts.listWithTagsLayout.hideFilters": "Hide filters",
    "layouts.listWithTagsLayout.searchLabel": "Search articles",
    "layouts.listWithTagsLayout.searchPlaceholder": "Search...",
    "layouts.listWithTagsLayout.searchNoResult": "No articles match your search.",
    "layouts.listWithTagsLayout.filterAll": "All",
    "layouts.listWithTagsLayout.filterYear": "Year",
    ...
    "layouts.postLayout.domaine": "Domain",
    "layouts.postLayout.category": "Category",
    "layouts.postLayout.technos": "Technos",
  ...
  fr: {
    ...
    "layouts.listWithTagsLayout.showFilters": "Filtrer",
    "layouts.listWithTagsLayout.hideFilters": "Masquer les filtres",
    "layouts.listWithTagsLayout.searchLabel": "Rechercher un article",
    "layouts.listWithTagsLayout.searchPlaceholder": "Rechercher...",
    "layouts.listWithTagsLayout.searchNoResult": "Aucun article ne correspond à votre recherche.",
    "layouts.listWithTagsLayout.filterAll": "Tout",
    "layouts.listWithTagsLayout.filterYear": "Année",
    ...
    "layouts.postLayout.domaine": "Domaine",
